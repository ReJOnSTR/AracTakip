    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          <Text style={[styles.title, { color: c.text }]}>Araç Takip</Text>
          <Text style={[styles.subtitle, { color: c.textSecondary }]}>Filo Yönetimi Paneli</Text>
        </View>
        ...
        <View style={styles.statsRow}>
          <GlassCard intensity={30} style={styles.statCard}>
            ...
            <Text style={[styles.statLabel, { color: c.textSecondary }]}>Toplam Araç</Text>
          </GlassCard>
          ...
          <GlassCard intensity={30} style={styles.statCard}>
            <Text style={[styles.statNum, { color: c.warning }]}>{maintenanceCount}</Text>
            <Text style={[styles.statLabel, { color: c.textSecondary }]}>Bakımda</Text>
          </GlassCard>
        </View>

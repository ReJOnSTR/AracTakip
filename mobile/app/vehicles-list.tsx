      ...
      <View style={[
        ...
        <View style={styles.headerInner}>
          ...
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={[styles.title, { color: c.text, marginVertical: 0, fontSize: 20 }]}>Araçlar</Text>
            <Text style={[styles.count, { color: c.textSecondary, fontSize: 13 }]}>{vehicles.length} araç</Text>
          </View>
